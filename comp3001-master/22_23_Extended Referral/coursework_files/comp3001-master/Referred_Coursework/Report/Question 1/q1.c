...
void q1 ( int m, int n, int it_max, double alpha, double omega, double tol );
...
int main ( ) {
  ...
  printf ( "\n  A program which solves the 2D q1 equation.\n" );


  wtime = omp_get_wtime ( );

  //---------------------routine to optimize----------------------------------
  q1 ( m, n, it_max, alpha, omega, tol );
