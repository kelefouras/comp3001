...
void slow_routine(double alpha, double beta);//you will optimize this routine
unsigned short int Compare(double alpha, double beta);
unsigned short int equal(double const a, double const b) ;

#define N 8192 //input size
__declspec(align(64)) double A[N][N], u1[N], u2[N], v1[N], v2[N], x[N], y[N], w[N], z[N], test[N];
...
void slow_routine(double alpha, double beta){
