...
#define VECTOR_LENGTH 1000 //input size
...
/*
* Kernel Function:  addWithThreads
* --------------------
...
*  the one-dimensional grid is composed of one single block
...
int main(int argc, char* argv[])
{
	...
	/* Definition of the structure of the execution configuration of the kernel based on parallelism of threads:
	*  - The 1D grid is composed of one single block
	...
	*/
	...
	addWithThreads << <dimGrid, dimBlock >> > (device_a, device_b, device_c);
