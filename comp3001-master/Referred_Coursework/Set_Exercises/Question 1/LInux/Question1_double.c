...
//compile with gcc Question1_double.c -o p -O3 -D_GNU_SOURCE  -march=native -mavx -lm -D_GNU_SOURCE -Wall -fopenmp
...
tmp = _mm256_fmadd_pd(a, const1, tmp);
tmp = _mm256_fmadd_pd(a, const2, tmp);
tmp = _mm256_fmadd_pd(a, const3, tmp);
tmp = _mm256_fmadd_pd(a, const4, tmp);
tmp = _mm256_fmadd_pd(a, const5, tmp);
tmp = _mm256_fmadd_pd(a, const6, tmp);
tmp = _mm256_fmadd_pd(a, const7, tmp);
tmp = _mm256_fmadd_pd(a, const8, tmp);
