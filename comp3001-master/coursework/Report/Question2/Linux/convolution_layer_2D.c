...
/*
For question.2C and question.2D:

The following values are initialized in 'void read_layer_dimensions()' routine. These values define the CNN layer's input parameters.
...
In question.2C and question.2D, you will use the following values:
    (Input_Output_batch_dim, Input_Y_dim, Input_X_dim, Input_depth_dim, Stride_Y_dim, Stride_X_dim, Mask_Y_dim, Mask_X_dim, Output_depth_dim) = (8,224,224,3,2,2,7,7,96), (8,55,55,96,1,1,1,1,16), (8,55,55,16,1,1,1,1,64), (8,55,55,16,1,1,3,3,64), (8,55,55,128,1,1,1,1,16), (8,55,55,32,1,1,3,3,128), (8,27,27,64,1,1,3,3,256)
