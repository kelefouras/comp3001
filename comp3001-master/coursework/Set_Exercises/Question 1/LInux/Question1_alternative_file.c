...
//compile with gcc Question1_alternative_file.c -o p -O3 -D_GNU_SOURCE  -march=native -mavx -lm -D_GNU_SOURCE -Wall -fopenmp
...
float A[N][N],X[N],Y[N] __attribute__((aligned(64)));
