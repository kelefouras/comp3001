...
#define N 4096*32 //arrays input size
#define TIMES 100000 //times to run
#define TILE 20 //tile size
#define ARITHMETICAL_OPS (N*64 + N/8)
...
__m256 const1,const2,const3,const4,const5,const6,const7,const8,a,tmp,tmp2;
...
gflops = (double) ARITHMETICAL_OPS / ( (double) diff / TIMES); //ARITHMETICAL_OPS /(nanoseconds/TIMES)
printf("elapsed time = %llu nanoseconds\n", (long long unsigned int) diff);
printf("elapsed time = %llu mseconds\n", (long long unsigned int) diff/1000000);
printf("output = %f \n%f GigaFLOPS achieved in core0 \n", out, gflops);
...
tmp = _mm256_fmadd_ps(a, const1, a);
...
tmp2 = _mm256_fmadd_ps(a, const2, a);
tmp2 = _mm256_fmadd_ps(a, const1, tmp2);
tmp2 = _mm256_fmadd_ps(a, const3, tmp2);
tmp2 = _mm256_fmadd_ps(a, const4, tmp2);
tmp2 = _mm256_fmadd_ps(a, const5, tmp2);
tmp2 = _mm256_fmadd_ps(a, const6, tmp2);
tmp2 = _mm256_fmadd_ps(a, const7, tmp2);
tmp2 = _mm256_fmadd_ps(a, const8, tmp2);
...
tmp2 = _mm256_fmadd_ps(a, const1, tmp2);
tmp2 = _mm256_fmadd_ps(a, const2, tmp2);
tmp2 = _mm256_fmadd_ps(a, const3, tmp2);
tmp2 = _mm256_fmadd_ps(a, const4, tmp2);
tmp2 = _mm256_fmadd_ps(a, const5, tmp2);
tmp2 = _mm256_fmadd_ps(a, const6, tmp2);
